...
# instance fields
.field final taskCompletionSource:LS3/e;
...
.method public constructor <init>(LS3/e;)V
    ...
    .line 3
    .line 4
    iput-object p1, p0, Lcom/google/firebase/installations/GetIdListener;->taskCompletionSource:LS3/e;
...
.method public onStateReached(Lcom/google/firebase/installations/local/PersistedInstallationEntry;)Z
    ...
    :cond_1
    :goto_0
    iget-object v0, p0, Lcom/google/firebase/installations/GetIdListener;->taskCompletionSource:LS3/e;
    ...
    .line 28
    invoke-virtual {v0, p1}, LS3/e;->b(Ljava/lang/Object;)V
