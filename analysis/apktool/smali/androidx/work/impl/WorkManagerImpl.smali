...
.field private final mWorkManagerScope:LM5/w;
...
.method public constructor <init>(Landroid/content/Context;Landroidx/work/Configuration;Landroidx/work/impl/utils/taskexecutor/TaskExecutor;Landroidx/work/impl/WorkDatabase;Ljava/util/List;Landroidx/work/impl/Processor;Landroidx/work/impl/constraints/trackers/Trackers;)V
    ...
    .line 42
    .line 43
    invoke-static {p3}, Landroidx/work/impl/WorkManagerImplExtKt;->createWorkManagerScope(Landroidx/work/impl/utils/taskexecutor/TaskExecutor;)LM5/w;
    ...
    .line 47
    iput-object p6, p0, Landroidx/work/impl/WorkManagerImpl;->mWorkManagerScope:LM5/w;
    ...
    .line 80
    .line 81
    invoke-static {p6, p1, p2, p4}, Landroidx/work/impl/UnfinishedWorkListenerKt;->maybeLaunchUnfinishedWorkListener(LM5/w;Landroid/content/Context;Landroidx/work/Configuration;Landroidx/work/impl/WorkDatabase;)V
...
.method public static synthetic a(Landroidx/work/impl/WorkManagerImpl;)Lm5/y;
    .locals 0

    .line 1
    invoke-direct {p0}, Landroidx/work/impl/WorkManagerImpl;->lambda$rescheduleEligibleWork$0()Lm5/y;
...
.method private synthetic lambda$rescheduleEligibleWork$0()Lm5/y;
    .locals 3
...
.method public getLastCancelAllTimeMillis()LI4/b;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 15
    .line 16
    invoke-direct {v2, v3, v0}, LI2/d;-><init>(ILjava/lang/Object;)V
    ...
    .line 20
    .line 21
    invoke-static {v1, v0, v2}, Landroidx/work/ListenableFutureKt;->executeAsync(Ljava/util/concurrent/Executor;Ljava/lang/String;LB5/a;)LI4/b;
...
.method public getLastCancelAllTimeMillisLiveData()Landroidx/lifecycle/G;
    ...
    .line 2
    .line 3
    invoke-virtual {v0}, Landroidx/work/impl/utils/PreferenceUtils;->getLastCancelAllTimeMillisLiveData()Landroidx/lifecycle/G;
...
.method public getWorkInfoById(Ljava/util/UUID;)LI4/b;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    .line 5
    invoke-static {v0, v1, p1}, Landroidx/work/impl/utils/StatusRunnable;->forUUID(Landroidx/work/impl/WorkDatabase;Landroidx/work/impl/utils/taskexecutor/TaskExecutor;Ljava/util/UUID;)LI4/b;
...
.method public getWorkInfoByIdFlow(Ljava/util/UUID;)LP5/h;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 9
    invoke-static {v0, p1}, Landroidx/work/impl/model/WorkSpecDaoKt;->getWorkStatusPojoFlowDataForIds(Landroidx/work/impl/model/WorkSpecDao;Ljava/util/UUID;)LP5/h;
...
.method public getWorkInfoByIdLiveData(Ljava/util/UUID;)Landroidx/lifecycle/G;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 15
    invoke-interface {v0, p1}, Landroidx/work/impl/model/WorkSpecDao;->getWorkStatusPojoLiveDataForIds(Ljava/util/List;)Landroidx/lifecycle/G;
    ...
    .line 25
    .line 26
    invoke-static {p1, v0, v1}, Landroidx/work/impl/utils/LiveDataUtils;->dedupedMappedLiveDataFor(Landroidx/lifecycle/G;Lp/a;Landroidx/work/impl/utils/taskexecutor/TaskExecutor;)Landroidx/lifecycle/G;
...
.method public getWorkInfos(Landroidx/work/WorkQuery;)LI4/b;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    .line 5
    invoke-static {v0, v1, p1}, Landroidx/work/impl/utils/StatusRunnable;->forWorkQuerySpec(Landroidx/work/impl/WorkDatabase;Landroidx/work/impl/utils/taskexecutor/TaskExecutor;Landroidx/work/WorkQuery;)LI4/b;
...
.method public getWorkInfosById(Ljava/util/List;)Landroidx/lifecycle/G;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public getWorkInfosByTag(Ljava/lang/String;)LI4/b;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    .line 5
    invoke-static {v0, v1, p1}, Landroidx/work/impl/utils/StatusRunnable;->forTag(Landroidx/work/impl/WorkDatabase;Landroidx/work/impl/utils/taskexecutor/TaskExecutor;Ljava/lang/String;)LI4/b;
...
.method public getWorkInfosByTagFlow(Ljava/lang/String;)LP5/h;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 8
    .line 9
    invoke-interface {v1}, Landroidx/work/impl/utils/taskexecutor/TaskExecutor;->getTaskCoroutineDispatcher()LM5/s;
    ...
    .line 13
    invoke-static {v0, v1, p1}, Landroidx/work/impl/model/WorkSpecDaoKt;->getWorkStatusPojoFlowForTag(Landroidx/work/impl/model/WorkSpecDao;LM5/s;Ljava/lang/String;)LP5/h;
...
.method public getWorkInfosByTagLiveData(Ljava/lang/String;)Landroidx/lifecycle/G;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 7
    invoke-interface {v0, p1}, Landroidx/work/impl/model/WorkSpecDao;->getWorkStatusPojoLiveDataForTag(Ljava/lang/String;)Landroidx/lifecycle/G;
...
.method public getWorkInfosFlow(Landroidx/work/WorkQuery;)LP5/h;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 13
    invoke-static {p1}, Landroidx/work/impl/utils/RawQueries;->toRawQuery(Landroidx/work/WorkQuery;)Lj2/f;
    ...
    .line 17
    invoke-static {v0, v1, p1}, Landroidx/work/impl/model/RawWorkInfoDaoKt;->getWorkInfoPojosFlow(Landroidx/work/impl/model/RawWorkInfoDao;LM5/s;Lj2/f;)LP5/h;
...
.method public getWorkInfosForUniqueWork(Ljava/lang/String;)LI4/b;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    .line 5
    invoke-static {v0, v1, p1}, Landroidx/work/impl/utils/StatusRunnable;->forUniqueWork(Landroidx/work/impl/WorkDatabase;Landroidx/work/impl/utils/taskexecutor/TaskExecutor;Ljava/lang/String;)LI4/b;
...
.method public getWorkInfosForUniqueWorkFlow(Ljava/lang/String;)LP5/h;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 13
    invoke-static {v0, v1, p1}, Landroidx/work/impl/model/WorkSpecDaoKt;->getWorkStatusPojoFlowForName(Landroidx/work/impl/model/WorkSpecDao;LM5/s;Ljava/lang/String;)LP5/h;
...
.method public getWorkInfosForUniqueWorkLiveData(Ljava/lang/String;)Landroidx/lifecycle/G;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 7
    invoke-interface {v0, p1}, Landroidx/work/impl/model/WorkSpecDao;->getWorkStatusPojoLiveDataForName(Ljava/lang/String;)Landroidx/lifecycle/G;
...
.method public getWorkInfosLiveData(Landroidx/work/WorkQuery;)Landroidx/lifecycle/G;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 11
    invoke-interface {v0, p1}, Landroidx/work/impl/model/RawWorkInfoDao;->getWorkInfoPojosLiveData(Lj2/f;)Landroidx/lifecycle/G;
...
.method public getWorkManagerScope()LM5/w;
    .locals 1

    .line 1
    iget-object v0, p0, Landroidx/work/impl/WorkManagerImpl;->mWorkManagerScope:LM5/w;
...
.method public rescheduleEligibleWork()V
    ...
    .line 17
    .line 18
    invoke-static {v0, v2, v1}, Landroidx/work/TracerKt;->traced(Landroidx/work/Tracer;Ljava/lang/String;LB5/a;)Ljava/lang/Object;
...
.method public updateWork(Landroidx/work/WorkRequest;)LI4/b;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-static {p0, p1}, Landroidx/work/impl/WorkerUpdater;->updateWorkImpl(Landroidx/work/impl/WorkManagerImpl;Landroidx/work/WorkRequest;)LI4/b;
