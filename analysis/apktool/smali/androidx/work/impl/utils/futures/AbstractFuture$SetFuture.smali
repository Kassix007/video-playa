...
# direct methods
.method public constructor <init>(Landroidx/work/impl/utils/futures/AbstractFuture;LI4/b;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 5
    .line 6
    iput-object p2, p0, Landroidx/work/impl/utils/futures/AbstractFuture$SetFuture;->future:LI4/b;
...
.method public run()V
    ...
    .line 8
    :cond_0
    iget-object v0, p0, Landroidx/work/impl/utils/futures/AbstractFuture$SetFuture;->future:LI4/b;

    .line 9
    .line 10
    invoke-static {v0}, Landroidx/work/impl/utils/futures/AbstractFuture;->getFutureValue(LI4/b;)Ljava/lang/Object;
