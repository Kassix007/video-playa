...
.method public final beginUniqueWork(Ljava/lang/String;Landroidx/work/ExistingWorkPolicy;Landroidx/work/OneTimeWorkRequest;)Landroidx/work/WorkContinuation;
    ...
    .line 1
    invoke-static {p3}, Lcom/google/android/gms/internal/measurement/n2;->z(Ljava/lang/Object;)Ljava/util/List;
...
.method public abstract getLastCancelAllTimeMillis()LI4/b;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
            "LI4/b;"
...
.method public abstract getLastCancelAllTimeMillisLiveData()Landroidx/lifecycle/G;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public abstract getWorkInfoById(Ljava/util/UUID;)LI4/b;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/util/UUID;",
...
.method public abstract getWorkInfoByIdFlow(Ljava/util/UUID;)LP5/h;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/util/UUID;",
...
.method public abstract getWorkInfoByIdLiveData(Ljava/util/UUID;)Landroidx/lifecycle/G;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/util/UUID;",
...
.method public abstract getWorkInfosByTag(Ljava/lang/String;)LI4/b;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/lang/String;",
...
.method public abstract getWorkInfosByTagFlow(Ljava/lang/String;)LP5/h;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/lang/String;",
...
.method public abstract getWorkInfosByTagLiveData(Ljava/lang/String;)Landroidx/lifecycle/G;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/lang/String;",
...
.method public abstract getWorkInfosFlow(Landroidx/work/WorkQuery;)LP5/h;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Landroidx/work/WorkQuery;",
...
.method public abstract getWorkInfosForUniqueWork(Ljava/lang/String;)LI4/b;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/lang/String;",
...
.method public abstract getWorkInfosForUniqueWorkFlow(Ljava/lang/String;)LP5/h;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/lang/String;",
...
.method public abstract getWorkInfosForUniqueWorkLiveData(Ljava/lang/String;)Landroidx/lifecycle/G;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/lang/String;",
...
.method public abstract getWorkInfosLiveData(Landroidx/work/WorkQuery;)Landroidx/lifecycle/G;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Landroidx/work/WorkQuery;",
...
.method public abstract updateWork(Landroidx/work/WorkRequest;)LI4/b;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Landroidx/work/WorkRequest;",
