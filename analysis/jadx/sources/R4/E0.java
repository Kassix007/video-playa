...
public final /* synthetic */ class E0 implements InterfaceC0593w {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final E0 f6752a;
    ...
    static {
        E0 e02 = new E0();
        f6752a = e02;
        Z5.P p7 = new Z5.P("com.web2native.FloatingActionMenuTab", e02, 4);
        p7.k("url", true);
        p7.k("icon", true);
        p7.k("type", true);
        p7.k("label", true);
    ...
    public final Object c(Y5.b bVar) {
        ...
        aVarA.l(fVar);
        return new G0(i, str, str2, str3, str4);
    }
}
