...
public final class e {
    ...
    public static final e f13060c = new e("COMPOSITION");
    ...
    public e(String... strArr) {
        this.f13061a = Arrays.asList(strArr);
    }
    ...
    */
    public final boolean a(int r8, java.lang.String r9) {
        ...
        L92:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: g3.e.a(int, java.lang.String):boolean");
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && e.class == obj.getClass()) {
            e eVar = (e) obj;
            if (!this.f13061a.equals(eVar.f13061a)) {
                return false;
            }
            f fVar = this.f13062b;
            f fVar2 = eVar.f13062b;
            if (fVar != null) {
    ...
    public final int hashCode() {
        int iHashCode = this.f13061a.hashCode() * 31;
        f fVar = this.f13062b;
    ...
    public final String toString() {
        ...
        sb.append(",resolved=");
        sb.append(this.f13062b != null);
        sb.append('}');
        return sb.toString();
    }

    public e(e eVar) {
        this.f13061a = new ArrayList(eVar.f13061a);
        this.f13062b = eVar.f13062b;
    }
}
