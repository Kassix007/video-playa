...
public abstract class PersistedInstallationEntry {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public PersistedInstallationEntry withAuthToken(String str, long j, long j7) {
        return toBuilder().setAuthToken(str).setExpiresInSecs(j).setTokenCreationEpochInSecs(j7).build();
    }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public PersistedInstallationEntry withRegisteredFid(String str, String str2, long j, String str3, long j7) {
        return toBuilder().setFirebaseInstallationId(str).setRegistrationStatus(PersistedInstallation.RegistrationStatus.REGISTERED).setAuthToken(str3).setRefreshToken(str2).setExpiresInSecs(j7).setTokenCreationEpochInSecs(j).build();
    }
