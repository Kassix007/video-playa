...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    public FirebaseInstallations(FirebaseApp firebaseApp, Provider<HeartBeatController> provider, ExecutorService executorService, Executor executor) {
        this(executorService, executor, firebaseApp, new FirebaseInstallationServiceClient(firebaseApp.getApplicationContext(), provider), new PersistedInstallation(firebaseApp), Utils.getInstance(), new Lazy((Provider) new b(1, firebaseApp)), new RandomFidGenerator());
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    private d addGetAuthTokenListener() {
        e eVar = new e();
        addStateListeners(new GetAuthTokenListener(this.utils, eVar));
        return eVar.f7306a;
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    private d addGetIdListener() {
        e eVar = new e();
        addStateListeners(new GetIdListener(eVar));
        return eVar.f7306a;
    }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    /* JADX DEBUG: Method merged with bridge method: lambda$doRegistrationOrRefresh$3(Z)V */
    /* JADX INFO: Access modifiers changed from: private */
    ...
    public void lambda$doRegistrationOrRefresh$3(boolean z5) {
        ...
        } catch (FirebaseInstallationsException e7) {
            triggerOnException(e7);
        }
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    /* JADX DEBUG: Method merged with bridge method: lambda$getToken$2(Z)V */
    /* JADX INFO: Access modifiers changed from: private */
    ...
    public final void lambda$getToken$2(boolean z5) {
        ...
        this.networkExecutor.execute(new a(this, z5, 0));
    }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    /* JADX DEBUG: Incorrect finally slice size: {[IF, INVOKE, INVOKE, GOTO] complete}, expected: {[IF, INVOKE, INVOKE] complete} */
    ...
    private void preConditionChecks() {
        AbstractC1887A.e(getApplicationId(), APP_ID_VALIDATION_MSG);
        AbstractC1887A.e(getProjectIdentifier(), PROJECT_ID_VALIDATION_MSG);
        AbstractC1887A.e(getApiKey(), API_KEY_VALIDATION_MSG);
        AbstractC1887A.b(Utils.isValidAppIdFormat(getApplicationId()), APP_ID_VALIDATION_MSG);
        AbstractC1887A.b(Utils.isValidApiKeyFormat(getApiKey()), API_KEY_VALIDATION_MSG);
    }
    ...
    public d delete() {
        return AbstractC0597a.m(this.backgroundExecutor, new x(3, this));
    }
    ...
    public d getId() {
        ...
        d dVarAddGetIdListener = addGetIdListener();
        this.backgroundExecutor.execute(new RunnableC0089m(15, this));
        return dVarAddGetIdListener;
    }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    @Override // com.google.firebase.installations.FirebaseInstallationsApi
    public d getToken(boolean z5) {
        preConditionChecks();
        d dVarAddGetAuthTokenListener = addGetAuthTokenListener();
        this.backgroundExecutor.execute(new a(this, z5, 1));
        return dVarAddGetAuthTokenListener;
    }
    ...
    public static FirebaseInstallations getInstance(FirebaseApp firebaseApp) {
        AbstractC1887A.b(firebaseApp != null, "Null is not a valid value of FirebaseApp.");
