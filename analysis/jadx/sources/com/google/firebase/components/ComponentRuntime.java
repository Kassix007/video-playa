...
public class ComponentRuntime implements ComponentContainer, ComponentLoader {
            ...
            for (final Component<?> component : list) {
                this.components.put(component, new Lazy(new Provider() { // from class: com.google.firebase.components.d
                    ...
                    public final Object get() {
                        return this.f11734a.lambda$discoverComponents$0(component);
                    }
                }));
            }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    private void doInitializeEagerComponents(Map<Component<?>, Provider<?>> map, boolean z5) {
    ...
    public void initializeEagerComponents(boolean z5) {
        ...
        doInitializeEagerComponents(map, z5);
    }
