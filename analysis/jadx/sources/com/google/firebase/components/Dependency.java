...
public final class Dependency {
    ...
    private Dependency(Class<?> cls, int i, int i7) {
        this((Qualified<?>) Qualified.unqualified(cls), i, i7);
    }
    ...
    private static String describeInjection(int i) {
        ...
        throw new AssertionError(i.i(i, "Unsupported injection: "));
    }
    ...
    public String toString() {
        ...
        sb.append(", injection=");
        return i.k(sb, describeInjection(this.injection), "}");
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    private Dependency(Qualified<?> qualified, int i, int i7) {
