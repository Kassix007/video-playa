...
public final class Component<T> {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public static <T> Component<T> intoSet(T t6, Class<T> cls) {
        return intoSetBuilder(cls).factory(new a(2, t6)).build();
    }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    @Deprecated
    public static <T> Component<T> of(Class<T> cls, T t6) {
        return builder(cls).factory(new a(3, t6)).build();
    }
    ...
    private Component(String str, Set<Qualified<? super T>> set, Set<Dependency> set2, int i, int i7, ComponentFactory<T> componentFactory, Set<Class<?>> set3) {
        this.name = str;
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    public static <T> Component<T> intoSet(T t6, Qualified<T> qualified) {
        return intoSetBuilder(qualified).factory(new a(1, t6)).build();
    }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    @SafeVarargs
    public static <T> Component<T> of(T t6, Class<T> cls, Class<? super T>... clsArr) {
        return builder(cls, clsArr).factory(new a(4, t6)).build();
    }
    ...
    @SafeVarargs
    public static <T> Component<T> of(T t6, Qualified<T> qualified, Qualified<? super T>... qualifiedArr) {
        return builder(qualified, qualifiedArr).factory(new a(0, t6)).build();
    }
