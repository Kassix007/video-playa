...
public final class r extends BaseAdapter {
    ...
    public static final int f11541d = y.c(null).getMaximum(4);

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public static final int f11542e = (y.c(null).getMaximum(7) + y.c(null).getMaximum(5)) - 1;
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final int a() {
        int firstDayOfWeek = this.f11545c.f11474u;
        q qVar = this.f11543a;
        Calendar calendar = qVar.f11534q;
        int i = calendar.get(7);
        if (firstDayOfWeek <= 0) {
            firstDayOfWeek = calendar.getFirstDayOfWeek();
        }
        int i7 = i - firstDayOfWeek;
        return i7 < 0 ? i7 + qVar.f11537t : i7;
    }
    ...
    public final Long getItem(int i) {
        ...
        int iA = (i - a()) + 1;
        Calendar calendarA = y.a(this.f11543a.f11534q);
        calendarA.set(5, iA);
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final int c() {
        return (a() + this.f11543a.f11538u) - 1;
    }
    ...
    */
    public final android.view.View getView(int r5, android.view.View r6, android.view.ViewGroup r7) {
        /*
            ...
            com.google.android.material.datepicker.c r1 = r4.f11544b
            if (r1 != 0) goto Lf
        ...
        L27:
            ...
            int r6 = r5 - r6
            if (r6 < 0) goto L5d
            com.google.android.material.datepicker.q r7 = r4.f11543a
            int r2 = r7.f11538u
            if (r6 < r2) goto L36
            goto L5d
        L36:
