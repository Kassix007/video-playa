...
public class SystemJobScheduler implements Scheduler {
    ...
    public void scheduleInternal(WorkSpec workSpec, int i) {
        ...
        try {
            ...
            IllegalStateException illegalStateException = new IllegalStateException(strCreateErrorMessage, e7);
            InterfaceC1752a schedulingExceptionHandler = this.mConfiguration.getSchedulingExceptionHandler();
