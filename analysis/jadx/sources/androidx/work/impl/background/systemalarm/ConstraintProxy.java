...
abstract class ConstraintProxy extends BroadcastReceiver {
    ...
    public static void updateAll(Context context, List<WorkSpec> list) {
        ...
        while (it.hasNext()) {
            ...
            z5 |= constraints.getRequiredNetworkType() != NetworkType.NOT_REQUIRED;
            if (zRequiresBatteryNotLow && zRequiresCharging && zRequiresStorageNotLow && z5) {
                break;
            }
        }
        context.sendBroadcast(ConstraintProxyUpdateReceiver.newConstraintProxyUpdateIntent(context, zRequiresBatteryNotLow, zRequiresCharging, zRequiresStorageNotLow, z5));
    }
